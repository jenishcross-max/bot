...
- Если выше салон спросил имя («как вас записать», «подскажите имя»), то следующий короткий
  ответ клиента — это его имя, даже если слов о записи в нём нет. Верни intent "book"
  и это слово в client_name. «Тестбек» после такого вопроса — имя, а не "none".
